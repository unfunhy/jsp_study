 ...
 * Generated at: 2019-10-28 13:59:30 UTC
...
public final class updatePost_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 request.setCharacterEncoding("UTF-8"); 
	...
	System.out.println("updatePost: "+searchTag+searchText);
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t<form id='update' class='form-inline justify-content-center' method=\"POST\" action='Control.jsp'>\r\n");
      ...
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class='p-2'>\r\n");
      out.write("\t\t\t\t\t제목: <input class='form-control' type='text' name='title' id='title' style='width: 340px;' value='");
      out.print(title);
      out.write("'> \r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t<textarea style='border:none; width:100%; height:100%;' id='contents' name='contents'>");
      out.print(contents);
      out.write("</textarea>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t\r\n");
      ...
      out.write("\t\t\t\tif (!session.getParameter(\"username\").equals(\"관리자\")) {\r\n");
      out.write("\t\t\t\t\talert(\"공지 태그는 관리자만 사용가능합니다.\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t} else {\r\n");
      out.write("\t\t\t\tdocument.getElementById(\"update\").submit();\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t}\r\n");
